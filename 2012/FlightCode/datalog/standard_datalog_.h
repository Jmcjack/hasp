 ...
 *
 * $Id: standard_datalog.h 761 2012-01-19 17:23:49Z murch $
 */
...
#define NUM_FLOAT_VARS 48	///< Number of variables that will be logged as floats
#define NUM_INT_VARS 2		///< Number of variables that will be logged as ints
#define NUM_SHORT_VARS 4	///< Number of variables that will be logged as shorts
...
char* saveAsShortNames[NUM_SHORT_VARS] = {"mode", "satVisible", "navValid","cpuLoad"};
