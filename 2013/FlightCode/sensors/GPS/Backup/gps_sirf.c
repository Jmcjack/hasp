 ...
 *
 * $Id: gps_sirf.c 760 2012-01-12 16:00:45Z murch $
 */
...
//		gpsData_ptr ->UTC_year = getbeuw(base,11);
//		gpsData_ptr ->UTC_month = base[13];
//		gpsData_ptr ->UTC_day = base[14];
//		gpsData_ptr ->UTC_hour = base[15];
//		gpsData_ptr ->UTC_min = base[16];
//		gpsData_ptr ->UTC_secs = (double)(getbeuw(base,17))*1e-03;
