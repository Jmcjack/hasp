 ...
 *
 * $Id: EKF_15state.c 775 2012-02-21 19:54:46Z murch $
 */
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//#define		SIG_W_AX	9.81e-1		//0.1*g
//#define		SIG_W_AY	9.81e-1
//#define		SIG_W_AZ	9.81e-1
//#define		SIG_W_GX	0.01658		//0.95 deg/s
//#define		SIG_W_GY	0.01658
//#define		SIG_W_GZ	0.01658
//#define		SIG_A_D		0.04905	    //5e-3*g
//#define		TAU_A		300
//#define		SIG_G_D		0.005236	//0.3 deg/s
//#define		TAU_G		300
//
//#define		SIG_GPS_P_NE 1
//#define		SIG_GPS_P_D  3
//#define		SIG_GPS_V	 0.2
//
//#define		P_P_INIT	3.0
//#define		P_V_INIT	0.2
//#define		P_A_INIT	0.2617994	//15 deg
//#define		P_HDG_INIT	1.5707963	//90 deg
//#define		P_AB_INIT	4.90500		//0.5*g
//#define		P_GB_INIT	0.0872665	//5 deg/s
//
...
//	eul[0][0] = navData_ptr->phi; eul[1][0] = navData_ptr->the;
//	eul[2][0] = navData_ptr->psi;
//	
...
//	C_N2B = eul2dcm(eul, C_N2B);
//	C_B2N = mat_tran(C_N2B, C_B2N);
//	
//	Rbodtonav = create_R(eul,Rbodtonav);
//	
//	// Attitude Update
//	// ... Calculate Navigation Rate
//	nr = navrate(a_temp31,b_temp31,nr);
//	
//	dx = mat_mul(Rbodtonav,om_ib,dx);
//	navData_ptr->phi += imu_dt*dx[0][0];
//	navData_ptr->the += imu_dt*dx[1][0];
//	navData_ptr->psi += imu_dt*dx[2][0];
//	
//	// Velocity Update
...
//	
//	// ... gs2att
//	a_temp31 = mat_mul(C_B2N,f_b,a_temp31);
//	temp33 = sk(a_temp31,temp33);
...
//	
//	// ... att2gyr
//	F[6][12] = C_B2N[0][0]; F[6][13] = C_B2N[0][1]; F[6][14] = C_B2N[0][2];
//	F[7][12] = C_B2N[1][0]; F[7][13] = C_B2N[1][1]; F[7][14] = C_B2N[1][2];
//	F[8][12] = C_B2N[2][0]; F[8][13] = C_B2N[2][1]; F[8][14] = C_B2N[2][2];
//	
//	// ... Accel Markov Bias
...
//	
//	G[6][3] = C_B2N[0][0];	G[6][4] = C_B2N[0][1]; G[6][5] = C_B2N[0][2];
//	G[7][3] = C_B2N[1][0];	G[7][4] = C_B2N[1][1]; G[7][5] = C_B2N[1][2];
//	G[8][3] = C_B2N[2][0];	G[8][4] = C_B2N[2][1]; G[8][5] = C_B2N[2][2];
//	
...
//		C_B2N = mat_tran(C_N2B,C_B2N);
//		
//		eul[0][0] = x[6][0]; eul[1][0] = x[7][0]; eul[2][0] = x[8][0];
//		temp33 = sk(eul,temp33);
//		atemp33 = mat_sub(I3,temp33,atemp33);
//		temp33 = mat_mul(atemp33,C_B2N, temp33);
//		
//		C_B2N = ortho(temp33,C_B2N);
//		C_N2B = mat_tran(C_B2N,C_N2B);
//		eul = dcm2eul(eul, C_N2B);
//		navData_ptr->phi = eul[0][0];
//		navData_ptr->the = eul[1][0];
//		navData_ptr->psi = eul[2][0];
//		
