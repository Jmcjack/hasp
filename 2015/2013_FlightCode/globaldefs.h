 ...
 *
 * $Id: globaldefs.h 772 2012-02-16 23:05:17Z murch $
 */
...
struct control {
	double dthr_rc;		///< [0-1], throttle command from R/C
	double de_rc;		///< [rad], elevator command, +TED, from R/C
	double dr_rc;		///< [rad], rudder command, +TEL, from R/C
	double da_l_rc;		///< [rad], left aileron command, +TED, from R/C
	double da_r_rc;		///< [rad], right aileron command, +TED, from R/C
	double df_l_rc;		///< [rad], left flap command, +TED, from R/C
	double df_r_rc;		///< [rad], right flap command, +TED, from R/C
	double dg_rc;		///< [rad], gear command, from R/C, controls RxMux
...
struct datalog {
	...
	char** saveAsXrayNames;		///< pointer to char array of variable names for floats
	double** saveAsXrayPointers;	///< pointer to double pointer array to variables that will be saved as floats
